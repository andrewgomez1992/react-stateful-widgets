...
import React, { useState } from 'react'; /* STEP 0 */ // adding useState
...
export default function Moods() {
  ...
  const style = {
    fontSize: '1.5em',
    marginBottom: '0.3em',
    color: mood === happyMood ? 'royalblue' : 'crimson', /* STEP 2 */ // if mood is happyMood, royalblue, else, crimson
  };

  return (
    <div className='widget-moods container'>
      <h2>Moods</h2>
      <div id='mood' style={style}>{mood}</div> {/* STEP 3, INTERPOLATING mood*/} 
      <div> 
